...
export const createPlan = async (req, res, next) => {
  try {
    ...
    const plan = await createContributionPlan({
      ...req.body,
      created_by,
    });
...
export const getPlanById = async (req, res, next) => {
  try {
    const plan = await getContributionPlanById({
...
export const getPlans = async (req, res, next) => {
  try {
    const plans = await getOwnerContributionPlans({
      owner_type: req.query.owner_type,
      owner_id: req.query.owner_id,
      status: req.query.status,
      contribution_type: req.query.contribution_type,
...
export const activatePlan = (req, res, next) =>
  executeStatusChange(
    activateContributionPlan,
    req,
    res,
...
export const pausePlan = (req, res, next) =>
  executeStatusChange(
    pauseContributionPlan,
    req,
    res,
...
export const resumePlan = (req, res, next) =>
  executeStatusChange(
    resumeContributionPlan,
    req,
    res,
...
export const completePlan = (req, res, next) =>
  executeStatusChange(
    completeContributionPlan,
    req,
    res,
...
export const cancelPlan = (req, res, next) =>
  executeStatusChange(
    cancelContributionPlan,
    req,
    res,
...
export const getPlanObligations = async (req, res, next) => {
  try {
    const obligations = await getContributionPlanObligations({
      plan_id: req.params.planId,
      owner_type: req.query.owner_type,
      owner_id: req.query.owner_id,
      status: req.query.status,
...
export const getPlanPayments = async (req, res, next) => {
  try {
    const payments = await getContributionPlanPayments({
      plan_id: req.params.planId,
      owner_type: req.query.owner_type,
      owner_id: req.query.owner_id,
      status: req.query.status,
...
export const getPlanFinancialSummary = async (req, res, next) => {
  try {
    const summary = await getContributionPlanFinancialSummary({
      plan_id: req.params.planId,
      owner_type: req.query.owner_type,
      owner_id: req.query.owner_id,
    });
