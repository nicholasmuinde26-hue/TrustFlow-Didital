...
export default function AccountCard({ account }) {
  ...
  const balanceColor = balance < 0 ? "text-red-600" : "text-slate-900 dark:text-mist";

  return (
    <div className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm dark:border-obsidian-border dark:bg-obsidian-card">
      <div className="flex items-center justify-between">
        ...
        <span className="rounded-full bg-slate-100 px-3 py-1 text-xs font-medium text-slate-700 dark:bg-obsidian-raised dark:text-mist-muted">
