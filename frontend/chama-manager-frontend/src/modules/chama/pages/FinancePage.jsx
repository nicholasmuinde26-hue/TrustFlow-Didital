    ...
    <div className="space-y-10">
      ...
      <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
        ...
        <div>
          ...
          <p className="mt-3 max-w-3xl text-slate-500">
            Double-entry accounting, treasury management,
            contributions, payouts, savings, financial reporting,
            and audit-ready records for your workspace.
          </p>
      ...
      <section>
        ...
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
          ...
          <BalanceCard
            title="Cash Balance"
            value={summary?.cash_balance ?? "0.00"}
          />

          <BalanceCard
            title="Contributions"
            value={summary?.total_contributions ?? "0.00"}
          />

          <BalanceCard
            title="Outstanding Loans"
            value={summary?.outstanding_loans ?? "0.00"}
          />

          <BalanceCard
            title="Pending Payouts"
            value={summary?.pending_payouts ?? "0.00"}
          />
      ...
      <CashFlowCard
        inflow={summary?.cash_in ?? "0.00"}
        outflow={summary?.cash_out ?? "0.00"}
      />
      ...
      <DashboardSection
        ...
        cards={[
          ...
          },
          {
            ...
            icon: CreditCard,
            color: "text-blue-600",
            to: `/workspace/${workspaceId}/finance/transactions`,
          },
          {
          ...
          },
          {
            ...
            to: `/workspace/${workspaceId}/finance/accounts`,
          },
          {
            title: "Payouts",
            icon: ArrowLeftRight,
            color: "text-red-600",
            to: `/workspace/${workspaceId}/finance/payouts`,
          },
          {
            title: "Savings",
            icon: PiggyBank,
            color: "text-pink-600",
            to: `/workspace/${workspaceId}/finance/savings`,
          },
        ]}
      />
        ...
        cards={[
          {
            ...
            icon: Scale,
            color: "text-indigo-600",
            to: `/workspace/${workspaceId}/finance/trial-balance`,
          },
          {
            title: "Balance Sheet",
            icon: Landmark,
            color: "text-emerald-600",
            to: `/workspace/${workspaceId}/finance/balance-sheet`,
          },
          {
            title: "Income Statement",
            icon: TrendingUp,
            color: "text-blue-600",
            to: `/workspace/${workspaceId}/finance/income-statement`,
          },
          {
            title: "Cash Flow",
            icon: BarChart3,
            color: "text-orange-600",
            to: `/workspace/${workspaceId}/finance/cash-flow`,
          },
          {
