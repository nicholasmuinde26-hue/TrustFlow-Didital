 ...
 */
router.get('/unread', protect, requireChamaMember, getUnreadNotifications);

/**
 * GET /api/v1/notifications/action-required
 * Get action-required notifications
 */
router.get('/action-required', protect, requireChamaMember, getActionRequiredNotifications);

/**
 * GET /api/v1/notifications/high-priority
 * Get high-priority notifications
 */
router.get('/high-priority', protect, requireChamaMember, getHighPriorityNotifications);

/**
 * GET /api/v1/notifications/category/:category
 * Get notifications by category
 */
router.get('/category/:category', protect, requireChamaMember, getNotificationsByCategory);

/**
 * GET /api/v1/notifications/counts
 * Get notification counts by state
 */
router.get('/counts', protect, requireChamaMember, getNotificationCounts);

/**
 * GET /api/v1/notifications/:notificationId
 * Get notification by ID
 */
router.get('/:notificationId', protect, requireChamaMember, getNotificationById);

/**
 * PATCH /api/v1/notifications/:notificationId/read
 * Mark notification as read
 */
router.patch('/:notificationId/read', protect, requireChamaMember, markNotificationAsRead);

/**
 * PATCH /api/v1/notifications/:notificationId/archive
 * Mark notification as archived
 */
router.patch('/:notificationId/archive', protect, requireChamaMember, markNotificationAsArchived);

/**
 * PATCH /api/v1/notifications/:notificationId/action
 * Mark action as completed
 */
router.patch('/:notificationId/action', protect, requireChamaMember, markActionCompleted);

/**
 * PATCH /api/v1/notifications/read-all
 * Mark all notifications as read
 */
router.patch('/read-all', protect, requireChamaMember, markAllNotificationsAsRead);
