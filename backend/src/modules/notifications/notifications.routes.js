 ...
 */
router.post('/toast', protect, sendToastNotification);

/**
 * POST /api/v1/notifications/confirmation/:templateType/validate
...
/**
 * GET /api/v1/notifications/chamas/:chamaId/statistics
 * Get notification statistics for chama (admin)
 */
router.get('/chamas/:chamaId/statistics', protect, requireChamaMember, getChamaNotificationStatistics);
